  ...
  return knex("table_name")
    ...
    .then(function() {
      ...
      return knex("grants").insert([
        {
          user_id: user,
          grant_title: "FedEx Small Business Grant",
          grant_number: Math.round(Math.random()),
          grant_status: Math.round(Math.random()),
          grant_description:
            "The FedEx Small Business Grant Contest awards three prizes. Grand prize is awarded to one winner: $50,000 plus $7,500 in FedEx Office print and business services. Silver prize is awarded to one winner: $30,000, plus $5,000 in FedEx Office print and business services. Bronze Prize: Eight winners of $15,000, plus $1,000 in FedEx Office print and business services. Write a short profile, upload photos, create a video, and get fans to vote for you in this contest.",
          grant_amount: "$50,000",
          due_date: "1/2/2020",
